...
<h2><a href="https://www.fghrsh.net/post/123.html" style="color: #38A3DB; text-decoration: none;">Live2D 看板娘
  v1.4</a> / Demo 1</h2>
<h3> - 常规引用 <span style="font-size: 12px;color: #666">(常规博客引用推荐)</span></h3>
<ul>
  <li><span title="常规博客引用推荐">Demo 1 (当前面页)</span></li>
  <li><a href="demo2-autoload.html" style="color: #38A3DB; text-decoration: none;" title="一般网站引用推荐">Demo 2 - 自动加载
    autoload.js</a></li>
  <li><a href="demo3-waifu-tips.html" style="color: #38A3DB; text-decoration: none;" title="博客园等网站引用推荐">Demo 3 -
    内置 waifu-tips.json</a></li>
</ul>
